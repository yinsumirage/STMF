...
TRAIN_BASE_POSE_HOLD_DROPOUT="${TRAIN_BASE_POSE_HOLD_DROPOUT:-0.0}"
TRAIN_SENSOR_NOISE_STD="${TRAIN_SENSOR_NOISE_STD:-0.0}"
TRAIN_SENSOR_DROPOUT="${TRAIN_SENSOR_DROPOUT:-0.0}"
...
echo "TRAIN_BASE_POSE_HOLD_DROPOUT=${TRAIN_BASE_POSE_HOLD_DROPOUT}"
echo "TRAIN_SENSOR_NOISE_STD=${TRAIN_SENSOR_NOISE_STD}"
echo "TRAIN_SENSOR_DROPOUT=${TRAIN_SENSOR_DROPOUT}"
...
train_refiner() {
  ...
  CUDA_VISIBLE_DEVICES="${gpu}" python scripts/train_sensor_refiner.py \
    ...
    --base_pose_hold_dropout "${TRAIN_BASE_POSE_HOLD_DROPOUT}" \
    --sensor_noise_std "${TRAIN_SENSOR_NOISE_STD}" \
    --sensor_dropout "${TRAIN_SENSOR_DROPOUT}" \
    --seed "${SEED}" \
    --device cuda \
    --log_every 20 \
